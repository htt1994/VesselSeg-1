...
def main():
    ...
    for epoch in args.epochs:
        for i_iter, batch in enumerate(trainloader):
            ...
            dice = dice(preds, labels)/BATCH_SIZE
            ...
            if i_iter % 100 == 0:
                ...
                writer.add_scalar('dice', dice, i_ter)
            ...
            print('iter = {} of {} completed, loss = {}, dice = {}'.format(i_iter, args.num_steps, loss.data.cpu().numpy(), dice))
